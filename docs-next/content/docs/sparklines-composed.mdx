...
description: Display multiple sparkline series together
---

import Simple from "@/components/examples/SparklinesComposed/Simple";
import TooltipExample from "@/components/examples/SparklinesComposed/TooltipExample";
