---
title: ReferenceLine
description: Reference line component for highlighting specific data points
---

import ReferenceLineSimple from "@/components/examples/ReferenceLine/Simple";

## Basic Example

The `<ReferenceLine/>` component is used to draw a line usually used to highlight specific points like mean.
