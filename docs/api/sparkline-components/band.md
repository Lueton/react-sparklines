...
If false set, the line of the band will be drawn linear. If true set the line of the band will be drawn curved. If number set, the line of the band will be
...
The name of data. This option will be used in tooltip to represent the band. If no value was set to this option, the value
...
Width of the line of the band, **usually calculated internally**.
...
Height of the line of the band, **usually calculated internally**.
...
The coordinates of all the points in the band, **usually calculated internally**.
